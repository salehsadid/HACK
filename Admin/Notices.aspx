<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Admin.master" CodeFile="Notices.aspx.cs" Inherits="AdminNotices" Title="Notices — HACK Admin" %>
...
<asp:Content ID="C1" ContentPlaceHolderID="AdminContent" runat="server">
    ...
    <section class="admin-card">
        ...
        <div class="admin-actions">
            <asp:Button ID="addButton" runat="server" CssClass="btn btn-primary" Text="Add Notice" ValidationGroup="Content" OnClick="AddContent_Click" />
        </div>
    </section>
