<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Admin.master" CodeFile="Gallery.aspx.cs" Inherits="AdminGallery" Title="Gallery — HACK Admin" %>
...
<asp:Content ID="C1" ContentPlaceHolderID="AdminContent" runat="server">
    ...
    <section class="admin-card">
        <header class="admin-section-head">
            <div><h2>Add Gallery Item</h2></div>
        </header>
        ...
        <div class="admin-actions">
            <asp:Button ID="addButton" runat="server" CssClass="btn btn-primary" Text="Add Gallery Item" ValidationGroup="Content" OnClick="AddContent_Click" />
        </div>
    </section>
