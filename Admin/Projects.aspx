<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Admin.master" CodeFile="Projects.aspx.cs" Inherits="AdminProjects" Title="Projects — HACK Admin" %>
...
<asp:Content ID="C1" ContentPlaceHolderID="AdminContent" runat="server">
    ...
    <section class="admin-card">
        ...
        <div class="admin-actions">
            <asp:Button ID="addButton" runat="server" CssClass="btn btn-primary" Text="Add Project" ValidationGroup="Content" OnClick="AddContent_Click" />
        </div>
    </section>
